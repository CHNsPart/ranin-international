...
export default function ProjectDetailClient({ project, allProjects }: Props) {
  ...
  const details = [
    { label: t("projects.client"), value: project.client, icon: Building2 },
    { label: t("projects.year"), value: project.year, icon: Calendar },
    { label: t("projects.duration"), value: project.duration, icon: Clock },
    { label: t("projects.status"), value: project.status, icon: Activity },
  ];
