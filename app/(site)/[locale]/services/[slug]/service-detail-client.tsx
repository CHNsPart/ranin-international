      ...
      <section className="relative bg-ranin-light py-24 lg:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:gap-16">
            ...
            >
              <SectionLabel className="text-ranin-accent">{t("services.overview")}</SectionLabel>
              <h2 className="mt-4 font-display text-4xl text-ranin-navy sm:text-5xl">
                {t("services.whatWeDeliver")}
              </h2>
            ...
            <div>
              ...
              >
                <SectionLabel className="text-ranin-accent">{t("services.capabilities")}</SectionLabel>
                <h2 className="mt-4 font-display text-4xl text-ranin-navy sm:text-5xl">
      ...
      <section className="bg-ranin-navy py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center">
            <SectionLabel>{t("services.gallery")}</SectionLabel>
            <h2 className="mt-4 font-display text-4xl text-white md:text-5xl">
              {t("services.projectGallery")}
            </h2>
          </div>
      ...
      <AnimatePresence>
        {lightboxIndex !== null && (
          ...
          >
            ...
            <button
              onClick={closeLightbox}
              className="absolute top-4 z-10 flex size-10 items-center justify-center text-white/60 transition-colors hover:text-white lg:top-6"
            ...
            {/* Counter */}
            <span
              className="absolute top-4 font-mono text-xs text-white/40 lg:top-6"
            ...
            <button
              ...
              className="absolute top-1/2 z-10 flex size-12 -translate-y-1/2 items-center justify-center text-white/50 transition-colors hover:text-white"
              style={{ left: 8, right: "auto" }}
            >
              <ChevronLeft className="size-8" style={{ transform: "none" }} />
            </button>
            ...
            >
              <ChevronRight className="size-8" style={{ transform: "none" }} />
            </button>
          </motion.div>
        )}
      </AnimatePresence>
