...
export const defaultClientsProjectsAr: ClientsProjectsData = {
  partnersHeading: "موثوق من قبل رواد الصناعة",
  partnersDescription:
    "شراكات مع كبرى شركات الهندسة والبناء والطاقة حول المملكة.",
  partnersRow1: [
    { src: "/partners/Saudi_Aramco_logo.png", alt: "Saudi Aramco" },
    { src: "/partners/SABIC_logo.png", alt: "SABIC" },
    { src: "/partners/MAADEN.png", alt: "Ma'aden" },
  ...
  portfolioHeading: "أبرز المشاريع",
  featuredProjects: [
    {
      title: "صيانة مجمع البتروكيماويات",
      sector: "البتروكيماويات",
      location: "مدينة الجبيل الصناعية",
      image: "/images/13.png",
    },
    {
      title: "دعم بناء الأبراج الشاهقة",
      sector: "البناء",
      location: "الرياض، المملكة العربية السعودية",
      image: "/images/30.png",
    },
    {
      title: "مشروع صيانة المصافي",
      sector: "النفط والغاز",
